...
const DEFAULT_SETTINGS: Record<string, string> = {
  ...
  TS_PROXY_MAX_CLIENT_LAG_CHUNKS: '600',
  TS_PROXY_MAX_BUFFERED_CHUNKS: '3600',
  ...
  TS_PROXY_SKIP_COOLDOWN_MS: '2000',
...
export function initDb(): Database.Database {
  ...
  const legacyTsProxyDefaults: Array<{ key: string; from: string; to: string }> = [
    ...
    { key: 'TS_PROXY_MAX_CLIENT_LAG_CHUNKS', from: '180', to: '600' },
    { key: 'TS_PROXY_MAX_BUFFERED_CHUNKS', from: '720', to: '3600' },
  ];
